        ...
        mainContent.innerHTML = `
            <div class="page-container">
                <div class="page-header">
                    <h1 style="font-family: var(--font-brand); font-size: 28px; font-weight: 400; color: var(--dx-teal);">PAINEL GERAL</h1>
                ...
                <a href="#pre-training-questionnaires" class="card" style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px; text-decoration: none; border-color: var(--dx-teal-border);">
                    <div style="width: 42px; height: 42px; border-radius: 10px; background: var(--dx-teal-dim); display: flex; align-items: center; justify-content: center; flex: 0 0 auto;">
                        <i class="ph ph-clipboard-text" style="font-size: 24px; color: var(--dx-teal);"></i>
                    </div>
